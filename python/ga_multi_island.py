...
def main():
    ...
    sleep_duration = 0.0001  # Fixed sleep duration

    num_workers_list = [1, 2, 4, 8]  # List of worker numbers to test
    ...
    print(f"\nRunning GA with sleep duration fixed at {sleep_duration} seconds")
    for num_workers in num_workers_list:
        ...
        print(f"Number of workers: {num_workers}, Total GA execution time: {execution_time:.6f} seconds, "
    ...
    # Use number of workers as x-axis positions
    x_positions = num_workers_list
    ...
    plt.title("Execution Time Breakdown by Number of Workers")
